...
[rb, cb, sb]=size(psf);
r = ra+rb; c=ca+cb; 
% p1 = (r-ra)/2; p2=(c-ca)/2; %% even
p1 = (r-ra-1)/2;p2 =(c-ca-1)/2; %% odd
...
%     projection = projection + real(con1(p1+1:r-p1,p2+1:c-p2)); %%even
    projection = projection + real(con1(p1+1:r-p1-1,p2+1:c-p2-1)); %% odd
end
end